...
export default function Home() {
  ...
  const events: ServiceNotice[] = [
    { noticeId: '1', type: 'event', title: '謹賀新年', description: '2025年もよろしくお願いします', thumbnailImg: 'https://i.pinimg.com/736x/f6/eb/1e/f6eb1e567a5b4827a9afb5195dcab446.jpg', date: '2025-01-01' },
    { noticeId: '2', type: 'event', title: 'いつでも3%Back!', description: '会員はいつでもポイントバックします', thumbnailImg: 'https://i.pinimg.com/736x/8f/05/4d/8f054d66b37f59a34fd878fc2e783087.jpg', date: '2025-01-01' },
    { noticeId: '3', type: 'event', title: '初めてのガイド', href: '/service/help', description: 'ヒルクルの使い方をご紹介します', thumbnailImg: 'https://i.pinimg.com/736x/19/f1/97/19f197e170d66608885cecb06326b8a7.jpg', date: '2025-01-01' },
    { noticeId: '4', type: 'event', title: 'パートナー募集', href: '/service/partner', description: 'パートナーを募集しています', thumbnailImg: 'https://i.pinimg.com/736x/75/d7/5b/75d75b4a87ea4a45b3dc78e8a30de06d.jpg', date: '2025-01-01' },
    { noticeId: '5', type: 'event', title: 'ランキング', description: '今週のランキングは？', thumbnailImg: 'https://i.pinimg.com/736x/c1/90/a8/c190a833901cfa35fd456012cb9c0f6d.jpg', date: '2025-01-01' },
  ];
  const quickList = [
