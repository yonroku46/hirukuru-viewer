...
export default function FavoritePage() {
  ...
  useEffect(() => {
    const dummyShops: Shop[] = [
      ...
      { shopId: '2', location: '福岡市中央区', name: 'チキンが一番', description: 'チキン専門店', type: 'bento', image: 'https://i.pinimg.com/736x/d2/bb/52/d2bb52d3639b77f024c8b5a584949644.jpg', ratingAvg: 4.0, businessHours: [
